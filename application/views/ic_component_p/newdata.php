...
<div class="panel-body">
    <form action="<?php echo site_url('ic_component_p/save') ?>" method="post" data-parsley-validate="true" id="formsave" name="formsave">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <textarea style="width: 400px;" class="form-control" id="description" name="description" rows="4"  data-parsley-required="true" placeholder=""/></textarea>
                </div>
            </div>
        </div>
