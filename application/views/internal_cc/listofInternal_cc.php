...
<div class="breadcrumb pull-right">
    <li>Home</li>
    <?php if($canADD):?>
    <li class="active"><a></a>Internal Control Components</li>
    <?php endif;?>
</div>
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title" style="margin-top: 5px;">Internal Control Components - <div class="btn btn-success btn-xs">Total of <?php echo number_format($total['total_internal_cc'], 0, "", ","); ?> entries</div></h4>
            </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($data as $row) : ?>
                                    <tr>
                                        ...
                                        <?php endif;?>
                                        <?php if($canDELETE): ?>
                                        <a href="<?php echo site_url('internal_cc/removedata').'/'.$row['id']?>" type="submit" title="delete" class="btn btn-xs btn-icon btn-circle btn-danger remove"><i class="fa fa-times"></i></a>
                                        <?php endif;?>
                                        </td>
                                    </tr>
                                    <?php $no += 1; ?>
...
$(function() {
    ...
    $('.edit').click(function() {
        var $id = $(this).attr('id');
        $.ajax({
          url: "<?php echo site_url('internal_cc/editdata') ?>",
          type: "post",
          data: {id: $id},
...
$(function() {
    ...
    $('.add').click(function() {
        $.ajax({
          url: "<?php echo site_url('internal_cc/newdata') ?>",
          type: "post",
          data: {},
          success:function(response) {
             $response = $.parseJSON(response);
