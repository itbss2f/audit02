...
<div class="breadcrumb pull-right">
    ...
    <li><a href="<?php echo site_url('entry_risk/listofAcceptedRisk')?>">Accepted Risks Records</li>
</div>
 <!-- begin row -->
<div class="row">
    <!-- begin col-12 -->
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Edit Accepted Risk - <?php echo $this->session->userdata('sess_company_name');?></h4>
            </div> 
            <div class="panel-body">  
                <form action="<?php echo site_url('entry_risk/updateaction/'.$data['id']) ?>" method="post" data-parsley-validate="true" name="form-wizard" name="formsave" id="formsave">
                    <div id="wizard">
                                    ...
                                    <div class="row">
                                     <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="btn btn-success btn-xs" type="text" id="bc_code" name="number" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" value="<?php echo $data['bc_code'] ?>">
                                        </div>    
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="textarea form-control" id="business_concern" name="business_concern" placeholder="Enter Business Concern ..." rows="8" data-parsley-required="true" required><?php echo $data['business_concern']?></textarea> 
                                        </div>
                                    </div>     
                                </div> 
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <textarea class="textarea form-control" rows="8" id="remarks" name="remarks" placeholder="Enter Remarks ..."><?php echo $data['remarks'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="code" name="number" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" value="<?php echo $data['code'] ?>" style="width: 150px;"> 
                                            <textarea class="textarea form-control" rows="8" title="action_plan" id="action_plan" name="action_plan" placeholder="Enter Action Plan ..." data-parsley-required="true" required><?php echo $data['action_plan'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Status</label>
                                            <select class="form-control" name="status" id="status" data-parsley-required="true" required>
                                                <option value="">--</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="b_status">
                                            <label>Status</label>
                                            <select class="form-control" name="bc_status" id="bc_status" style="width: 408px;" data-parsley-required="true" required>
                                                <option value="">--</option>
                                                <?php foreach ($bc_status as $ap_status) : ?> 
                                                <?php if ($ap_status['id'] == $data['bc_status']) : ?>  
                                                <option value="<?php echo $ap_status['id'] ?>" selected="selected"><?php echo $ap_status['status_code'].' - '.$ap_status['status_name'] ?></option>
                                                <?php else: ?>
                                                <option value="<?php echo $ap_status['id']?>"><?php echo $ap_status['status_code'].' - '.$ap_status['status_name'] ?></option>        
                                                <?php endif; ?>
