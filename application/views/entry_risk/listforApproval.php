<div class="breadcrumb pull-right">
    <li>Home</li>    
    <li class="active">Accepted Risk Entry for Approval</li>
</div>
<!-- begin row -->
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title" style="margin-top: 5px;">Accepted Risk Entry for Approval - <div class="btn btn-success btn-xs">Total of <?php echo number_format($approval['approval'], 0, "", ","); ?> entries</div></h4>
            </div>
                        ...
                        <table id="data-table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php if ($canEDIT) :?>
                                    <a href="<?php echo site_url('entry_risk/editAcceptedRisksfa').'/'.$row['id']?>" title="edit" class="btn btn-xs btn-icon btn-circle btn-primary edit"><i class="fa fa-pencil"></i></a> 
                                    <?php endif;?>
                                    <?php if ($canVIEW):?>
                                    ...
                                    <?php if ($row['is_duplicate'] != 1) : ?>
                                        <?php if($canAPPROVED):?>
                                        <a href="<?php echo site_url('entry_risk/approved').'/'.$row['code']?>" type="submit" title="approved" class="btn btn-xs btn-icon btn-circle btn-warning approved"><i class="fa fa-thumbs-up"></i></a>  
                                        <?php endif ;?>
                                    <?php else :?>                                   
                                        <?php if($canAPPROVED):?>
                                        <input type="hidden">
                                    ...
                                    <?php if ($row['is_duplicate'] != 1) : ?>
                                        ...
                                        <a href="<?php echo site_url('entry_risk/disapproved').'/'.$row['id']?>" title="disapproved" class="btn btn-xs btn-icon btn-circle btn-danger disapproved"><i class="fa fa-thumbs-down"></i></a>   
                                        <?php endif ;?>
                                    <?php else :?>                                   
                                        <?php if($canDISAPPROVED):?>
                                        <input type="hidden">
