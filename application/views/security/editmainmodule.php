...
<div class="panel-body">
    <form action="<?php echo site_url('security/updatemainmodule/'.$data['id']) ?>" method="post" name="formsave" id="formsave" data-parsley-validate="true">
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    <label>Module Name:</label>                                                 
                    <input class="form-control" type="text" name="name_main" id="name_main" value="<?php echo $data['name'] ?>"/>
                </div>
            </div>
        </div>
        <div class="row">
...
$("#cancel").click(function() {
    $("#modal_editmainmodule").dialog('close');
});  
