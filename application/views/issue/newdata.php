...
<div class="panel-body">
    <form action="<?php echo site_url('issue/save') ?>" method="post" data-parsley-validate="true" id="formsave" name="formsave">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    <label>Issue</label>
                    <textarea class="form-control" id="description" name="description" rows="4"  data-parsley-required="true" placeholder="New Issue"/></textarea>
                </div>
            </div>
        </div>
