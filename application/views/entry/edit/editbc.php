    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Edit Business Concern - <?php echo $this->session->userdata('sess_company_name');?></h4>
            </div>
            <div class="panel-body">
                <form action="<?php echo site_url('entry/updatebc/'.$data['bcid'].'/'.$data['bc_status']) ?>" method="post" data-parsley-validate="true" name="form-wizard" name="formsave" id="formsave">
                    <div id="wizard">
                            ...
                            <fieldset>
                                <div class="row">
                                    <div class="row-form-booking pull-right" style="margin-top: 12px;margin-right: 8px;">
                                        <button type="save" class="btn btn-success btn-sm" id="savebc" name="savebc" value="savebc">Save Update</button>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <button type="button" id="addActionCode" class="btn btn-default" title="Add Existing AP"><i class="fa fa-plus"></i></button>
                                            <?php else: ?>
                                            <a href="#"></a>
                                            <?php endif; ?>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="btn btn-success btn-xs" type="text" id="bc_code" name="bc_code" value="<?php echo $data['bc_code'] ?>" readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group" id="accode">
                                            <Label>Action Code:</label>
                                            <?php foreach ($apcodescount as $rowx) : ?>

                                                <?php foreach ($apcodes as $row) : ?>
                                                <!-- <?php if ($rowx['apidcount'] <= 1) : ?>
                                                ...
                                                <a href="<?php echo site_url('entry/viewap').'/'.$row['apid'].'/'.$row['code']?>" title="View" target="_blank"><?php echo $row['code']?></a>
                                                <a href="<?php echo site_url('entry/removetagging/'.$row['apid'].'/'.$row['bcid'])?>" type="submit" title="untagged" class="btn btn-xs btn-icon btn-circle btn-danger delete"><i class="fa fa-times"></i></a>
                                    ...
                                    <div class="col-md-6" id="xx_emp2" style="display:none;">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="emp2" id="emp2">
                                                ...
                                                <?php else: ?>
                                                <option value="<?php echo $emp2['user_id'] ?>"><?php echo $emp2['emp_code'].' - '.$emp2['fullname'] ?></option>
                                                <?php endif; ?>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6" id="xx_dept2" style="display:none;">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="dept2" id="dept2">
                                                ...
                                                <?php else: ?>
                                                <option value="<?php echo $dept2['id'] ?>"><?php echo $dept2['code'].' - '.$dept2['name'] ?></option>
                                                <?php endif; ?>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group date">
                                            <input type="text" class="btn btn-success btn-xs" id="due_date" name="due_date" value="<?php echo date('m/d/Y', strtotime($data['due_date'])) ?>" placeholder="mm-dd-yyyy" name="due_date" data-parsley-required="true" maxlength="10"/>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group date" id="d_implemented1">
                                            ...
                                            <input type="text" class="btn btn-success btn-xs" id="xdate_implemented" name="date_implemented" value="<?php echo date($data['date_implemented'])?>" placeholder="mm-dd-yyyy" maxlength="10" readonly="readonly"/>
                                            <?php else: ?>
                                            <input type="text" class="btn btn-success btn-xs datedayspicker3" id="xdate_implementedx" name="date_implemented" value="<?php echo date('m/d/Y', strtotime($data['date_implemented'])) ?>" placeholder="mm-dd-yyyy" maxlength="10" readonly="readonly"/>
                                            <?php endif; ?>
                                            <!--<span class="input-group-addon"><i class="fa fa-calendar"></i></span>-->
                                        </div>
                                        <div class="input-group date" id="d_implemented2" style="display:none">
                                            <input type="text" class="btn btn-success btn-xs datedayspicker3" id="xdate_implemented2" name="date_implemented" placeholder="mm-dd-yyyy" maxlength="10"/>
                                            <!--<span class="input-group-addon"><i class="fa fa-calendar"></i></span>-->
                                        </div>
                                ...
                                <div class="row">
                                    <div class="row-form-booking pull-right" style="margin-top: 12px;margin-right: 8px;">
                                        <button type="save" class="btn btn-success btn-sm" id="savebcbottom" name="savebcbottom" value="savebcbottom">Save Update</button>
                                    </div>
                                </div>
                          </fieldset>
                        </div>
...
<div id="modal_searchcode" title="Search Code"></div>
...
$("#savebc").click(function() {
    var confirm = window.confirm('Do you want to update this Business Concern?');
...
$(function() {
    ...
    $('#addActionCode').click(function() {
        var $bc_code = $("#bc_code").val();
        $.ajax({
          url: "<?php echo site_url('entry/searchofactioncode') ?>",
          type: "post",
          data: {bc_code: $bc_code},
          success:function(response) {
             $response = $.parseJSON(response);
              $("#modal_searchcode").html($response['searchofactioncode']).dialog('open');
              }
           });
        });
        return false;
