...
<div class="breadcrumb pull-right">
    ...
    <li><a href="<?php echo site_url('entry/businessconcernforapproval')?>">Business Concern for Approval</li>
</div>
 <!-- begin row -->
<div class="row">
    <!-- begin col-12 -->
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Edit Business Concern for Approval - <?php echo $this->session->userdata('sess_company_name');?></h4>
            </div>
            <div class="panel-body">
                <form action="<?php echo site_url('entry/updatebcfa/'.$data['bcid']) ?>" method="post" data-parsley-validate="true" name="form-wizard" name="formsave" id="formsave">
                    <div id="wizard">
                            ...
                            <fieldset>
                                <div class="row">
                                    <div class="row-form-booking pull-right" style="margin-top: 12px;margin-right: 8px;">
                                        <button type="save" class="btn btn-success btn-sm" id="savebcfa" name="savebcfa" value="savebcfa">Save Update</button>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <?php else: ?>
                                            <a href="<?php echo site_url('entry/editAction').'/'.$row['apid']?>" title="View" target="_blank"><?php echo $row['code'] ?></a>
                                            <?php endif; ?>
                                            <?php endforeach; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="assigned_audit" id="assigned_audit" data-parsley-group="wizard-step-1" data-parsley-required="true" required>
                                                <option value="">--</option>
                                                <?php foreach ($bc_users as $bc_users) : ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="b_status">
                                            ...
                                            <select class="form-control" name="bc_status" id="bc_status" data-parsley-required="true" required>
                                                <option value="">--</option>
                                            ...
                                            <?php else: ?>
                                            <select class="form-control" name="bc_status" id="bc_statusx" data-parsley-required="true" required>
                                                <?php foreach ($bc_status as $row) : ?>
                                                <?php if ($row['id'] == $data['bc_status']) : ?>
                                                <option value="<?php echo $row['id'] ?>" selected="selected"><?php echo $row['status_code'].' - '.$row['status_name'] ?></option>
                                                <?php endif; ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group date" id="d_implemented1">
                                            ...
                                            <?php else: ?>
                                            <input type="text" class="btn btn-success btn-xs datedayspicker" id="xdate_implementedx" name="date_implemented" value="<?php echo date('m/d/Y', strtotime($data['date_implemented'])) ?>" placeholder="mm-dd-yyyy" maxlength="10" readonly="readonly"/>
                                            <?php endif; ?>
                                            <!--<span class="input-group-addon"><i class="fa fa-calendar"></i></span>-->
                                        </div>
                                        <div class="input-group date" id="d_implemented2" style="display:none">
                                            <input type="text" class="btn btn-success btn-xs datedayspicker" id="xdate_implemented2" name="date_implemented" placeholder="mm-dd-yyyy" maxlength="10"/>
                                            <!--<span class="input-group-addon"><i class="fa fa-calendar"></i></span>-->
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="row-form-booking pull-right" style="margin-top: 12px;margin-right: 8px;">
                                        <button type="save" class="btn btn-success btn-sm" id="savebcfabottom" name="savebcfabottom" value="savebcfabottom">Save Update</button>
                                    </div>
                                </div>
                          </fieldset>
                        </div>
