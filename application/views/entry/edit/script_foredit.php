    ...
    $("#b_status").change(function(){
        ...
        $.ajax({
           ...
           success: function(response) {
                    if ($id != 10) {
                    $("#date_tag").val("");
                    $("#xdate_implemented2").val("");
                    $("#d_implemented1").show();
                    $("#date_implemented").attr('disabled', 'true');
                    $("#d_implemented2").hide();
                    $("#_status2").hide();
                    $("#_status").show();
                    $("#_status").attr('data-parsley-required', 'true');
                    $("#date_implementedx").attr('data-parsley-required', 'false');
                    $("#xdate_implemented2").attr('data-parsley-required', 'false');
                   }  else{
                      ...
                      $("#d_implemented2").show();
                      $("#_status2").show();
                      $("#_status2").attr('data-parsley-required', 'true');
                      $("#_status").hide();
                      $("#date_implementedx").attr('data-parsley-required', 'true');
                      $("#xdate_implemented2").attr('data-parsley-required', 'true'); // edit in bc date resolved
                     }
           }
        })
    });
