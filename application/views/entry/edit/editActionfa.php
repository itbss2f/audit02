...
<div class="breadcrumb pull-right">
    ...
    <li><a href="<?php echo site_url('entry/actionplanforapproval')?>">Action Plan for Approval</li>
</div>
 <!-- begin row -->
<div class="row">
    <!-- begin col-12 -->
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Edit Action Plan for Approval - <?php echo $this->session->userdata('sess_company_name');?></h4>
            </div>
            <div class="panel-body">
                <form action="<?php echo site_url('entry/updateactionfa/'.$data['id']) ?>" method="post" data-parsley-validate="true" name="form-wizard" name="formsave" id="formsave">
                    <div id="wizard">
                        ...
                        <div class="wizard-step-1">
                            <fieldset>
                                  ...
                                  <div class="row-form-booking pull-right" style="margin-top: 12px;margin-right: 8px;">
                                      <button type="save" class="btn btn-success btn-sm" id="saveactionfa" name="saveactionfa" value="saveactionfa">Save Update</button>
                                  </div>
                                  <div class="row">
									  <div class="col-md-2">
                                  ...
                                  <div class="row">
                                      <div class="col-md-2">
                                          <div class="form-group">
                                              ...
                                              <input class="form-control" type="text" id="code" name="code" value="<?php echo $data['code'] ?>" readonly="readonly" style="width: 150px;" data-parsley-required="true" required>
                                          </div>
                                      </div>
                                      <div class="col-md-8">
                                      </div>
                                      <div class="col-md-2">
                                          <div class="form-group">
                                              <Label>Bc Code:</label>
                                              <?php if ($data['bcis_approved'] == 0) : ?>
                                              <a href="<?php echo site_url('entry/editbc').'/'.$data['bcid']?>" title="View" target="_blank"><?php echo $data['bc_code']?></a>
                                              <?php else:?>
                                              <a href="<?php echo site_url('entry/editbcfa').'/'.$data['bcid']?>" title="View" target="_blank"><?php echo $data['bc_code']?></a>
                                              <?php endif;?>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              ...
                                              <select class="form-control" name="ap_dept" id="ap_dept" data-parsley-required="true" required/>
                                              <option value="">----</option>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              ...
                                              <select class="form-control" name="ap_dept_2" id="ap_dept_2"/>
                                              <option value="">----</option>
                                  ...
                                  <div class="row">
                                      <div class="col-md-12" id="apimpact_remarks" style="display:none;">
                                          ...
                                          <textarea class="textarea form-control" id="ap_impact_remarks" name="ap_impact_remarks" placeholder="Enter Impact Computation ..." rows="5"></textarea>
                                          <?php endif; ?>
                                      </div>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-4">
                                          <div class="form-group" id="_tags">
                                              ...
                                              <input style="width: 220px;" class="btn btn-success btn-xs" type="text" name="ap_date_tag" id="ap_date_tag" value="<?php echo $data['ap_date_tag'] ?>" readonly="readonly"/>
                                              <?php else: ?>
                                              <input style="width: 220px;" class="btn btn-success btn-xs" type="text" name="ap_date_tag" id="ap_date_tag" value="<?php echo date('F j\, Y \ l', strtotime($data['ap_date_tag'])) ?>" readonly="readonly"/>
                                              <?php endif; ?>
                                          </div>
                                      </div>
                                  </div>
                                  ...
                                  <div class="row">
                                      <div class="col-md-4">
                                          ...
                                          <div class="input-group date" id="default">
                                              <input type="text" class="btn btn-success btn-xs" id="ap_due_datex3" name="ap_due_date" value="<?php echo date('m/d/Y', strtotime($data['ap_due_date'])) ?>" placeholder="mm-dd-yyyy" readonly="readonly"/>
                                          </div>
                                      ...
                                      <div class="col-md-4">
                                          ...
                                          <div class="input-group date">
                                              ...
                                              <input type="text" class="btn btn-success btn-xs" name="ap_date_revised" id="ap_date_revised" value="<?php echo $data['ap_date_revised'] ?>" placeholder="mm-dd-yyyy" maxlength="10" readonly="readonly"/>
                                              <?php else: ?>
                                              <input type="text" class="btn btn-success btn-xs datedayspicker" name="ap_date_revised" id="ap_date_revisedx" value="<?php echo date('m/d/Y', strtotime($data['ap_date_revised'])) ?>" placeholder="mm-dd-yyyy" maxlength="10" readonly="readonly"/>
                                              <?php endif; ?>
                                      ...
                                      <div class="row-form-booking pull-right" style="margin-top: 12px;margin-right: 8px;">
                                          <button type="save" class="btn btn-success btn-sm" id="saveactionfabottom" name="saveactionfabottom" value="saveactionfabottom">Save Update</button>
                                      </div>
                                  </div>
                            </fieldset>
                        </div>
...
//end
//Save bottom
$("#saveactionfabottom").click(function() {
    var confirm = window.confirm('Do you want to update this Action Plan?');
