...
$("#ap_status").change(function(){
      ...
      $.ajax({
         url: "<?php echo site_url('entry/ap_ajaxstatusbc')?>",
         type: 'post',
         data: {id: $id},
         success: function(response) {
          if ($id != 2) {
            $("#ap_date_tag").val("");
            $("#ap_implemented1a").show();
            $("#ap_date_implemented_a").attr("disabled", true);
            $("#ap_date_implemented_a").attr('data-parsley-required', 'false');
            $("#ap_implemented2b").hide();
          } else {
                $("#ap_date_tag").val('<?php echo date('F j\, Y \ l') ?>');
                $("#ap_implemented2b").show();
                $("#ap_date_implemented_b").attr('data-parsley-required', 'true');
                $("#ap_date_implemented_b").attr("disabled", false);
                $("#ap_implemented1a").hide(); 
...
$("#ap_status2").change(function(){
    var $id = $("#ap_status2").val();
        $.ajax({
