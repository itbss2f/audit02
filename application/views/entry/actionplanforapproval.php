<div class="breadcrumb pull-right">
    <li>Home</li>
    <li class="active">Action Plan for Approval</li>
</div>
<!-- begin row -->
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title" style="margin-top: 5px;">Action Plan for Approval - <div class="btn btn-success btn-xs">Total of <?php echo number_format($actionforapproval['actionforapproval'], 0, "", ","); ?> entries</div></h4>
            </div>
                        ...
                        <table id="DataTable" class="table table-striped table-bordered ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left;"><?php echo $row['fullnameAPI'] ?></td>
                                    ...
                                    <?php if ($canEDIT) :?>
                                    <a href="<?php echo site_url('entry/editActionfa').'/'.$row['id']?>" title="edit" class="btn btn-xs btn-icon btn-circle btn-primary edit"><i class="fa fa-pencil"></i></a>
                                    <?php endif;?>
                                    <?#php if ($canVIEW):?>
                                    ...
                                    <?#php endif;?>
                                    <?php if($canAPPROVED):?>
                                    <a href="<?php echo site_url('entry/approved').'/'.$row['id'].'/'.$row['code']?>" type="submit" title="approved" class="btn btn-xs btn-icon btn-circle btn-warning approved"><i class="fa fa-thumbs-up"></i></a>
                                    <?php endif ;?>
                                    <?php if($canDISAPPROVED):?>
                                    <a href="<?php echo site_url('entry/disapprovedap').'/'.$row['id'].'/'.$row['code']?>" title="disapproved" class="btn btn-xs btn-icon btn-circle btn-danger disapproved"><i class="fa fa-thumbs-down"></i></a>
                                    <?php endif ;?>
                                    </td>
                                </tr>
                                <?php $no += 1; ?>
