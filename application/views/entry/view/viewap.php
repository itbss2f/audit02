                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="btn btn-success btn-xs" style="width: 200px;" type="text" name="entered_date" id="entered_date" value="<?php echo date('F j\, Y \ l', strtotime($data['ap_entered_date'])); ?>"/>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                    </div>
