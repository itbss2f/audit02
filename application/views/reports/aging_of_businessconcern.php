...
<div class="breadcrumb pull-right">
    ...
    <li class="active">Aging of Business Concern</li>
</div>
    <!-- begin row -->
    <!-- begin page-header -->
    <!--<h1 class="page-header">IES - Business Concern </h1>-->
    <!-- end page-header -->
    <!-- begin row -->
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Aging of Business Concern - <?php echo $this->session->userdata('sess_company_name');?></h4>
                </div>
                <!--End of Header-->
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group" style="margin-top:12px;margin-left: 210px;">
                    ...
                    <div class="row">
                        <div class="col-md-1">
                            <div class="input-group" style="margin-top:12px;">
                                ...
                                <option value="3">Aging by Status</option>
                                <option value="4">Aging by Company</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-2" id="generate">
                            <div class="input-group" style="margin-top :34px;margin-left: 75px;">
...
$("#generatereport").click(function(response) {
    ...
    if (countValidate == 0) {
        ...
        $("#source").attr('src', "<?php echo site_url('bc_report/generatereport') ?>/"+datefrom_as+"/"+reporttype+"/"+bc_status+"/"+dept+"/"+project_name+"/"+user_company+"/"+report_period);
...
$("#generatereport2").click(function(response) {
    ...
    if (countValidate == 0) {
        ...
        $("#source").attr('src', "<?php echo site_url('bc_report/generatereport2') ?>/"+datefrom+"/"+dateto+"/"+reporttype+"/"+bc_status+"/"+dept+"/"+project_name+"/"+user_company+"/"+report_period);

    }

});

$("#export_aging").click(function(response) {
