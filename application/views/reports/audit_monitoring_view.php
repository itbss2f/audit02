...
<div class="breadcrumb pull-right">
    ...
    <li class="active">Audit Monitoring</li>
</div>
    <!-- begin row -->
    <!-- begin page-header -->
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Audit Monitoring - <?php echo $this->session->userdata('sess_company_name');?></h4>
                </div>
                <!--End of Header-->
                    ...
                    <div class="row">
                        <div class="col-md-1">
                            <div class="input-group" style="margin-top:12px;">
                                ...
                                <select class="form-control" name="report_period" id="report_period" style="width:140px;">
                                <option value="">-----</option>
                        ...
                        <div class="col-md-2">
                            <div class="input-group" style="margin-top:12px;margin-left: 70px;">
                                ...
                                <select class="form-control" name="allstatus" id="allstatus" style="width:140px;">
                        ...
                        <div class="col-md-2">
                            <div class="input-group" style="margin-top:12px;margin-left: 40px;">
                                <label class="control-label">Project Name</label>
                                <select class="form-control" name="project_name" id="project_name" style="width:200px;">
                                <option value="0">All</option>
                        ...
                        <div class="col-md-2">
                            <div class="input-group" style="margin-top:12px;margin-left: 110px;">
                                <label class="control-label">Report Type</label>
                                <select class="form-control" name="reporttype" id="reporttype" style="width:120px;">
                                <option value="1">All</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-1" id="generate">
                            <div class="input-group" style="margin-top :34px;margin-left: 60px;">
                        ...
                        <div class="col-md-1" id="export">
                            <div class="input-group" style="margin-top :34px;margin-left: 60px;">
                                <button type="button" class="btn btn-success" name="export1" id="export1">Export</button>
                            </div>
                        </div>
                        ...
                        <!--<div class="col-md-1" id="export2" style="display: none;">
...
$("#generatereport").click(function(response) {
    ...
    if (countValidate == 0) {
        ...
        $("#source").attr('src', "<?php echo site_url('monitoring_report/generatereport') ?>/"+datefrom_as+"/"+reporttype+"/"+dept+"/"+project_name+"/"+user_company+"/"+report_period+"/"+allstatus);
...
$(document).ready( function() {
    ...
    $("#export1").die().live("click",function() {
        ...
        { 
        window.open("<?php echo site_url('monitoring_report/generate_excel/') ?>?datefrom_as="+datefrom_as+"&report_period="+report_period+"&reporttype="+reporttype+"&dept="+dept+"&project_name="+project_name+"&user_company="+user_company+"&allstatus="+allstatus, '_blank');
            window.focus();
        }
