...
<div class="breadcrumb pull-right">
    ...
    <li class="active">Summary of Action Plans</li>
</div>
    <!-- begin row -->
    <!-- begin page-header -->
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Summary of Action Plans - <?php echo $this->session->userdata('sess_company_name');?></h4>
                </div>
                <!--End of Header-->
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-1" id="date_as2" style="display: none;">
                            <div class="input-group" style="margin-left: 75px;">
                                <label class="control-label"></label>
                                <select class="form-control" name="report_period2" id="report_period2" style="width:150px;">
                                <option value="">-----</option>
                                <option value="1">w/back-up</option>
                                <option value="2">w/o back-up</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="input-group" style="margin-top:12px;">
                                ...
                                <select class="form-control" name="reporttype" id="reporttype" style="width:185px;">
                                <option value="1">Summary of Action Plans</option>
                                <option value="2">Summary of Action Detailed</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-1" id="generate">
                            <div class="input-group" style="margin-top :34px;margin-left: 30px;">
                        ...
                        <!-- <div class="col-md-2" id="export">
                            <div class="input-group" style="margin-top :34px;margin-left: 45px;">
...
$("#generatereport").click(function(response) {
    ...
    var report_period2 = $("#report_period2").val();
    ...
    var countValidate = 0;
    var validate_fields = ['#datefrom_as','#reporttype', '#status', '#report_period', '#report_period2'];
    ...
    $("#source").attr('src', "<?php echo site_url('summary_of_actionplan/generatereport') ?>/"+datefrom_as+"/"+reporttype+"/"+status+"/"+dept+"/"+project_name+"/"+user_company+"/"+report_period+"/"+report_period2);
...
$("#generatereport2").click(function(response) {
    ...
    var countValidate = 0;
    var validate_fields = ['#datefrom','#dateto','#reporttype', '#status', '#report_period'];
    ...
    $("#source").attr('src', "<?php echo site_url('summary_of_actionplan/generatereport2') ?>/"+datefrom+"/"+dateto+"/"+reporttype+"/"+status+"/"+dept+"/"+project_name+"/"+user_company+"/"+report_period);
