...
<div class="breadcrumb pull-right">
    ...
    <li class="active">Summary of Business Concern</li>
</div>
    <!-- begin row -->
    <!-- begin page-header -->
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Summary of Business Concern - <?php echo $this->session->userdata('sess_company_name');?></h4>
                </div>
                <!--End of Header-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="input-group" style="margin-top:12px;margin-left: 75px;">
                                ...
                                <select class="form-control" name="bc_status" id="bc_status" style="width:210px;">
                                <option value="">-----</option>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="input-group" style="margin-top:12px;">
                                ...
                                <option value="1">Summary of Business Concern</option>
...
$("#generatereport").click(function(response) {
    ...
    var countValidate = 0;
    var validate_fields = ['#datefrom_as','#reporttype', '#bc_status', '#report_period'];
    ...
    $("#source").attr('src', "<?php echo site_url('summary_of_bc/generatereport') ?>/"+datefrom_as+"/"+reporttype+"/"+bc_status+"/"+dept+"/"+project_name+"/"+user_company+"/"+report_period);
...
$("#generatereport2").click(function(response) {
    ...
    var countValidate = 0;
    var validate_fields = ['#datefrom','#dateto','#reporttype', '#bc_status', '#report_period'];
    ...
    $("#source").attr('src', "<?php echo site_url('summary_of_bc/generatereport2') ?>/"+datefrom+"/"+dateto+"/"+reporttype+"/"+status+"/"+dept+"/"+project_name+"/"+user_company+"/"+report_period);
