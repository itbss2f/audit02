...
class Issue_report extends CI_Controller {
    ...
    public function index() {
        ...
        $layout['content'] = $this->load->view('reports/status_by_issues',$data, true);
        $this->load->view('welcome_index', $layout); 
        
    }
    
    public function generatereport($datefrom_as, $reporttype, $status, $dept, $risk, $issue, $project_name, $user_company) {
    ...
    $reportname = ""; 
    if ($reporttype == 1) {
    $reportname = "STATUS OF ISSUE PER STATUS";
    $engine = $this->Crystal->create('Zend', Crystal_Template_Zend::SIZE_LEGAL_LANDSCAPE);  
    $fields = array(
                ...
                array('text' => 'Audit Staff', 'width' => .10, 'align' => 'right'),    
                array('text' => 'Remarks', 'width' => .05, 'align' => 'left')
                );
    }else if ($reporttype == 2) {
    $reportname = "STATUS OF ISSUE PER DEPARTMENT";    
    $engine = $this->Crystal->create('Zend', Crystal_Template_Zend::SIZE_LEGAL_LANDSCAPE);  
    $fields = array(
                array('text' => '#', 'width' => .03, 'align' => 'left', 'bold' => true),
                array('text' => 'Action Plan', 'width' => .15, 'align' => 'right'),
                ...
                array('text' => 'Aging', 'width' => .05, 'align' => 'center', 'bold' => true),
                array('text' => 'Audit Staff', 'width' => .10, 'align' => 'right'),    
                array('text' => 'Remarks', 'width' => .05, 'align' => 'right')
                );
    }else if ($reporttype == 3) {
    $reportname = "STATUS OF ISSUE PER RISK";    
    $engine = $this->Crystal->create('Zend', Crystal_Template_Zend::SIZE_LEGAL_LANDSCAPE);  
    $fields = array(
                array('text' => '#', 'width' => .03, 'align' => 'left', 'bold' => true),
                array('text' => 'Action Plan', 'width' => .15, 'align' => 'right'),
    ...
    $reportname = "STATUS OF ISSUE PER ISSUE";    
    $engine = $this->Crystal->create('Zend', Crystal_Template_Zend::SIZE_LEGAL_LANDSCAPE);  
    $fields = array(
                array('text' => '#', 'width' => .03, 'align' => 'left', 'bold' => true),
                array('text' => 'Action Plan', 'width' => .15, 'align' => 'right'),
    ...
    $reportname = "STATUS OF ISSUE PER PROJECT NAME";    
    $engine = $this->Crystal->create('Zend', Crystal_Template_Zend::SIZE_LEGAL_LANDSCAPE);  
    $fields = array(
                array('text' => '#', 'width' => .03, 'align' => 'left', 'bold' => true),
                array('text' => 'Action Plan', 'width' => .15, 'align' => 'right'),
                array('text' => 'Status', 'width' => .04, 'align' => 'left'),
                array('text' => 'Department', 'width' => .09, 'align' => 'left'),
                ...
                array('text' => 'Due Date', 'width' => .05, 'align' => 'left'),
                array('text' => 'Person', 'width' => .10, 'align' => 'center'),
                array('text' => 'Aging', 'width' => .06, 'align' => 'center'),
                array('text' => 'Audit Staff', 'width' => .10, 'align' => 'right'),    
                array('text' => 'Remarks', 'width' => .05, 'align' => 'right')
                );    
    }
    ...
    $fields = array(
                ...
                array('text' => 'Aging', 'width' => .06, 'align' => 'center', 'bold' => true),
                array('text' => 'Audit Staff', 'width' => .08, 'align' => 'left'),    
                array('text' => 'Remarks', 'width' => .05, 'align' => 'left')
                );    
    } 
    ...
    $listx = $this->model_issues->getStatusByIssues($datefrom_as, $reporttype, $status, $dept, $risk, $issue, $project_name);
    ...
    public function generatereport2($datefrom, $dateto, $reporttype, $status, $dept, $risk, $issue, $project_name, $user_company) {
    ...
    $listx = $this->model_issues->getStatusByIssues2($datefrom, $dateto, $reporttype, $status, $dept, $risk, $issue, $project_name);
